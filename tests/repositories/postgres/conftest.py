...
``tests/conftest.py`` so that the shared ``TestEventStoreContract``
parametrized suite and the migration-script specs under
``tests/scripts/`` can both compose them. Tests
